document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.feature-card, .platform-item, .section-title, .donation-card').forEach(el => {
        el.style.opacity = '0';
    ...
    const paymentLinks = donationModal ? donationModal.querySelectorAll('[data-payment-provider]') : [];
